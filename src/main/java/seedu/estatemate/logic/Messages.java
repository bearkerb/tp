...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX = "The tenant index provided is invalid";
    public static final String MESSAGE_INVALID_PERSON_INDEX_TO_DELETE = "Invalid tenant index detected. "
