 ...
 */
public class AddCommandParser implements Parser<AddTenantCommand> {
    ...
    public AddTenantCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_EMAIL)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddTenantCommand.MESSAGE_USAGE));
        }
