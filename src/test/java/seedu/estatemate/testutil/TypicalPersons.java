...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withLease("2025-01-01 2030-01-02").withLeaseAmount("850.00")
            .withPayDate("2025-02-01").withTags("friends").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432").withLease("2027-12-12 2030-12-12")
            .withLeaseAmount("1450.00").withPayDate("2028-01-12").withTags("owesMoney", "friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street")
            .withLease("2026-01-05 2026-12-05").withLeaseAmount("500.00").withPayDate("2026-02-05").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street")
            .withLease("2025-06-12 2030-12-25").withLeaseAmount("925.00").withPayDate("2025-07-12")
            .withTags("friends").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave")
            .withLease("2024-03-21 2028-09-21").withLeaseAmount("325.20").withPayDate("2024-04-21").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo")
            .withLease("2027-04-15 2030-08-02").withLeaseAmount("1500.00").withPayDate("2027-05-15").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street")
            .withLease("2026-11-12 2030-05-16").withLeaseAmount("10500.00").withPayDate("2026-12-12").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india")
            .withLease("2026-04-08 2030-04-25").withLeaseAmount("1475.00").withPayDate("2026-05-08").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withAddress("chicago ave")
            .withLease("2025-07-17 2030-03-30").withLeaseAmount("3700.00").withPayDate("2025-08-17").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withLease(VALID_LEASE_AMY)
            .withLeaseAmount(VALID_LEASE_AMOUNT_AMY).withPayDate(VALID_PAY_DATE_AMY)
            .withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withLease(VALID_LEASE_BOB)
            .withLeaseAmount(VALID_LEASE_AMOUNT_BOB).withPayDate(VALID_PAY_DATE_BOB)
